                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '0.9rem' }}>
                            Click the "Connect Wallet" button in the header to connect your Web3 wallet (MetaMask, etc.).
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '0.9rem' }}>
                            Click "Buy Flips" to purchase flip packages. Each flip gives you one chance to flip the coin.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '0.9rem' }}>
                            Click "Flip Coin" to flip! <strong>Heads = good</strong>, your streak increases. <strong>Tails = bad</strong>, your streak resets to 0.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '0.9rem' }}>
                            If you win, go to the "CLAIM" page to collect your prize pool winnings!
                        </p>
                    </div>
                </div>
